					...
					<form action="../reply/doModify" method="POST" onsubmit="replyWrite_submitForm(this); return false;">
						...
						<div class="mt-2 border border-gray-400 rounded-lg text-base p-4">
							...
							<div class="flex justify-end">
								<a onclick="replyModify_cancle(\${i});" class="btn-text-link btn btn-active btn-ghost mr-2">취소</a>
								<button class="btn-text-link btn btn-active btn-ghost">등록</button>
							</div>
						</div>
					</form>
					`;
...
<%-- 						<div class="mb-2"><span>${rq.loginedMember.nickname }</span></div> --%>
						...
						<div class="flex justify-end"><button class="btn-text-link btn btn-active btn-ghost">등록</button></div>
					</div>
				</form>
			</c:if>
