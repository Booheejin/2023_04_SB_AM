		...
		<div class="container mx-auto px-3">
			...
			<div class="mt-2 flex justify-center">
				<div class="btn-group">
					...
					<c:if test="${page == 1 }">
						<a class="btn btn-md btn-disabled">«</a>
						<a class="btn btn-md btn-disabled">&lt;</a>
					</c:if>
					<c:if test="${page > 1 }">
						<a class="btn btn-md" href="?boardId=${board.id }&page=1">«</a>
						<a class="btn btn-md" href="?boardId=${board.id }&page=${page - 1 }">&lt;</a>
					</c:if>
					...
					<c:if test="${page < pagesCount }">
						<a class="btn btn-md" href="?boardId=${board.id }&page=${page + 1 }">&gt;</a>
						<a class="btn btn-md" href="?boardId=${board.id }&page=${pagesCount }">»</a>
					</c:if>
					<c:if test="${page == pagesCount }">
						<a class="btn btn-md btn-disabled">&gt;</a>
						<a class="btn btn-md btn-disabled">»</a>
